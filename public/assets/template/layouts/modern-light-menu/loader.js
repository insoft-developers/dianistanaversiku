window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: url_asset+'assets/template/admin/src/assets/img/logo.svg',
                    lightLogo: url_asset+'assets/template/admin/src/assets/img/logo2.svg'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            // if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', url_asset+'assets/template/admin/src/assets/img/logo.svg')
                }
            // } else {
            //     if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            // if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', url_asset+'assets/template/admin/src/assets/img/logo2.svg')
                }
            // } else {
            //     if (document.querySelector('.navbar-logo')) {

...
$(document).ready(function() {
    ...
    btnAdd = '&emsp;&emsp; <button type="button" class="btn btn-outline-primary btn-sm" title="Tambah Data User" id="btnAdd"> <i class="fas fa-plus"></i> Tambah Data User</button>';
    ...
    listDataTables("listTable","user-list",btnRefresh,btnAdd);
    ...
    listDataTables("listTableTrash","user-list-trash",btnRefreshTrash);
})

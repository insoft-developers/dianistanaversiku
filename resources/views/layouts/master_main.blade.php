...
<head>
    ...
    <title>@yield("title_public") | DianIstana</title>
...
<body class="" data-bs-spy="scroll" data-bs-target="#navSection" data-bs-offset="140">
        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-text">
                    <a href="{{ route("home_public") }}" class="nav-link"> DianIstana </a>
                </li>
            </ul>
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/profile-30.png" class="rounded-circle">
                            </div>
                        </div>
                    </a>
    ...
    <script src="{{ asset('') }}assets/template/layouts/horizontal-light-menu/app.js"></script>
    <!-- END GLOBAL MANDATORY STYLES -->

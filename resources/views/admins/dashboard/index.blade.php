...
<link href="{{ asset('') }}assets/template/src/assets/css/light/components/list-group.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{ asset('') }}assets/template/src/assets/css/light/widgets/modules-widgets.css">    

<link href="{{ asset('') }}assets/template/src/assets/css/dark/components/list-group.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="{{ asset('') }}assets/template/src/assets/css/dark/widgets/modules-widgets.css">   
        ...
        <div class="widget-content">
            <div class="account-box">
                ...
                <div class="info-box">
                    <div class="icon">
                        <span>
                            <img src="{{ asset('') }}assets/template/src/assets/img/money-bag.png" alt="money-bag">
                        </span>
                    </div>
            ...
            <div class="meta-info">
                ...
                <div class="avatar--group">
                    ...
                    <div class="avatar translateY-axis">
                        <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/profile-8.jpeg"/>
                    </div>
                    <div class="avatar translateY-axis">
                        <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/profile-12.jpeg"/>
                    </div>
                    <div class="avatar translateY-axis">
                        <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/profile-19.jpeg"/>
                    </div>
...
<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
    <div class="widget widget-card-one">
        <div class="widget-content">
            ...
            <div class="media">
                <div class="w-img">
                    <img src="{{ asset('') }}assets/template/src/assets/img/profile-19.jpeg" alt="avatar">
                </div>
...
<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
    <div class="widget widget-card-two">
        <div class="widget-content">
            ...
            <div class="media">
                <div class="w-img">
                    <img src="{{ asset('') }}assets/template/src/assets/img/g-8.png" alt="avatar">
                </div>
                <div class="media-body">
            ...
            <div class="card-bottom-section">
                ...
                <div class="img-group">
                    <img src="{{ asset('') }}assets/template/src/assets/img/profile-19.jpeg" alt="avatar">
                    <img src="{{ asset('') }}assets/template/src/assets/img/profile-6.jpeg" alt="avatar">
                    <img src="{{ asset('') }}assets/template/src/assets/img/profile-8.jpeg" alt="avatar">
                    <img src="{{ asset('') }}assets/template/src/assets/img/profile-3.jpeg" alt="avatar">
                </div>
    ...
    <div class="widget widget-wallet-one">
        ...
        <ul class="list-group list-group-media">
            <li class="list-group-item ">
                <div class="media">
                    <div class="me-3">
                        <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/netflix.svg" class="img-fluid rounded-circle">
                    </div>
                    <div class="media-body">
            ...
            <li class="list-group-item">
                <div class="media">
                    <div class="me-3">
                        <img alt="avatar" src="{{ asset('') }}assets/template/src/assets/img/apple-app-store.svg" class="img-fluid rounded-circle">
                    </div>
                    <div class="media-body">
        ...
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-13.jpeg" alt="avatar"><span>Luke Ivory</span></div></td>
                        ...
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-7.jpeg" alt="avatar"><span>Andy King</span></div></td>
                        ...
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-10.jpeg" alt="avatar"><span>Laurie Fox</span></div></td>
                        ...
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-5.jpeg" alt="avatar"><span>Ryan Collins</span></div></td>
                        ...
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-4.jpeg" alt="avatar"><span>Irene Collins</span></div></td>
                        ...
                        <tr>
                            <td><div class="td-content customer-name"><img src="{{ asset('') }}assets/template/src/assets/img/profile-11.jpeg" alt="avatar"><span>Sonia Shaw</span></div></td>
        ...
        <div class="widget-content">
            <div class="table-responsive">
                <table class="table table-scroll">
                    ...
                    <tbody>
                        <tr>
                            <td><div class="td-content product-name"><img src="{{ asset('') }}assets/template/src/assets/img/product-headphones.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Headphone</p><p class="prd-category text-primary">Digital</p></div></div></td>
                        ...
                        <tr>
                            <td><div class="td-content product-name"><img src="{{ asset('') }}assets/template/src/assets/img/product-shoes.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Shoes</p><p class="prd-category text-warning">Faishon</p></div></div></td>
                        ...
                        <tr>
                            <td><div class="td-content product-name"><img src="{{ asset('') }}assets/template/src/assets/img/product-watch.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Watch</p><p class="prd-category text-danger">Accessories</p></div></div></td>
                        ...
                        <tr>
                            <td><div class="td-content product-name"><img src="{{ asset('') }}assets/template/src/assets/img/product-laptop.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Laptop</p><p class="prd-category text-primary">Digital</p></div></div></td>
                        ...
                        <tr>
                            <td><div class="td-content product-name"><img src="{{ asset('') }}assets/template/src/assets/img/product-camera.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Camera</p><p class="prd-category text-primary">Digital</p></div></div></td>
